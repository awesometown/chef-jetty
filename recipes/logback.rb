directory "/opt/jetty/lib/logging" do
	owner node[:jetty][:user]
	group node[:jetty][:group]
end

remote_file "/opt/jetty/lib/logging/slf4j-api-1.7.6.jar" do
...
remote_file "/opt/jetty/lib/logging/logback-classic-1.1.1.jar" do
...
remote_file "/opt/jetty/lib/logging/logback-core-1.1.1.jar" do
...
template "/opt/jetty/resources/logback.xml" do
